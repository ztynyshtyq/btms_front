...
export const apiSendOnApprove = (accessToken, expenseReport) => dispatch => {
    ...
    return fetch(urls.API_APPROVE, {
        ...
        .then(json => {
            dispatch(setSingleExpenseReportForUserApproval({...expenseReport, status: "approved by manager"}))
