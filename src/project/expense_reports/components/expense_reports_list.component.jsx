...
const Component = ({apiGetExpenseReportsFromUser, user, expenseReportsFromUserRequests}) => {
    // TODO: write middleware in order to change names to correct
    useEffect(() => {
        apiGetExpenseReportsFromUser(user.access_token).then(console.log("priletelo"));
    }, []);
